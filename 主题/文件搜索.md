...
```shell
# https://stackoverflow.com/questions/7501697/how-to-find-all-files-with-a-filename-that-ends-with-tilde
find . -type f -name '*~'
# find and delete
...
EasyFind - DEVOMNthink

[ggreer/the_silver_searcher](https://github.com/ggreer/the_silver_searcher)：A code-searching tool similar to ack, but faster

[Geoff Greer's site: The Silver Searcher](https://geoff.greer.fm/ag/)
...
[How to find duplicate filenames (recursively) in a given directory? BASH - Stack Overflow](https://stackoverflow.com/questions/16276595/how-to-find-duplicate-filenames-recursively-in-a-given-directory-bash)
