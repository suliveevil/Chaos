...
零宽字符：`\U200B`、`\U200C`、`\U200D`、`\UFEFF`

中文基本汉字：`4E00-9FA5`

## 编码实现

UTF-8，可以看做是对 Unicode 的压缩算法
...
[Unicode strings - Rosetta Code](https://rosettacode.org/wiki/Unicode_strings)
